...
public class MyMainTest {
    ...
    private File newCreateInputFile1() throws Exception {
    ...
    private File newCreateInputFile2() throws Exception {
        File file1 =  myCreateTmpFile();
        FileWriter fileWriter = new FileWriter(file1);
    ...
    private File newCreateInputFile3() throws Exception {
        File file1 =  myCreateTmpFile();
        FileWriter fileWriter = new FileWriter(file1);
    ...
    public void myMainTest01() throws Exception {
        File inputFile1 = newCreateInputFile1();
        String args[] = {"-b", "", "Bill", "--",inputFile1.getPath()};
        Main.main(args);
    ...
    public void myMainTest02() throws Exception {
        ...
        File inputFile1 = newCreateInputFile1();
        File inputFile2 = newCreateInputFile2();
        File inputFile3 = newCreateInputFile3();

        String args[] = {"-i","-b","-l", "HHowdy", "Hello", "--", inputFile1.getPath(), inputFile2.getPath(), inputFile3.getPath()};
        Main.main(args);
    ...
    public void myMainTest04() throws Exception {
        File inputFile2 = newCreateInputFile1();
        String args[] = {"-b","", "Bill", "--",inputFile2.getPath()};
        Main.main(args);
        assertEquals("Usage: Replace [-b] [-f] [-l] [-i] <from> <to> -- <filename> [<filename>]*", errStream.toString().trim());
    }
    ...
    public void myMainTest05() throws Exception {
        File inputFile = newCreateInputFile2();
        inputFile.delete();
        String args[] = {"Bill", "William", "--", inputFile.getPath()};
        Main.main(args);
    ...
    public void myMainTest07() throws Exception {
        ...
        String args[] = {"-b","-f","-l","-i","Howdy", "Hello", "--", inputFile1.getPath(), inputFile2.getPath(), inputFile3.getPath()};
        Main.main(args);
    ...
    public void myMainTest09() throws Exception {
        ...
        String args[] = {"-b","-i","-f", "HHowdy", "'Hello'", "--", inputFile1.getPath()};
        Main.main(args);
    ...
    public void myMainTest10() throws Exception {
        ...
        String args[] = {"-i","-b", "-f", "HHowdy", "Hello", "--", inputFile1.getPath(), inputFile2.getPath(), inputFile3.getPath()};
        Main.main(args);
    ...
    public void myMainTest14() throws Exception {
        ...
        File inputFile1 = newCreateInputFile1();
        File inputFile2 = newCreateInputFile2();
        String args[] = {"HHowdy", "Hello", "--", inputFile1.getPath(),inputFile2.getPath()};
        Main.main(args);
    ...
    public void myMainTest15() throws Exception {
        File inputFile = newCreateInputFile1();
    ...
    public void myMainTest16() throws Exception {
        ...
        File inputFile2 = newCreateInputFile2();
        File inputFile3 = newCreateInputFile3();
        String args[] = {"'HHowdy'", "Hello", "--", inputFile1.getPath(),inputFile2.getPath(),inputFile3.getPath()};
        Main.main(args);
    ...
    File inputFile2 = newCreateInputFile2();
    File inputFile3 = newCreateInputFile3();
    String args[] = {"-f","Howdy", "Hello", "--", inputFile1.getPath(),inputFile2.getPath(),inputFile3.getPath()};
    Main.main(args);
    ...
    public void myMainTest18() throws Exception {
        ...
        File inputFile1 = newCreateInputFile1();
        String args[] = {"'HHowdy'", "'Hello'", "--", inputFile1.getPath()};
        Main.main(args);
    ...
    public void myMainTest19() throws Exception {
    	...
    	File inputFile2 = newCreateInputFile2();
        String args[] = {"-f","-f","Howdy", "Hi", "--",inputFile2.getPath()};
        Main.main(args);
    ...
    public void myMainTest21() throws Exception {
        ...
        String args[] = {"-f","-i",  "Howdy", "Hello", "--", inputFile1.getPath(),inputFile2.getPath(),inputFile3.getPath()};
        Main.main(args);
    ...
    String args[] = {"-b", "BBill", "William", "--", inputFile1.getPath(), inputFile2.getPath(), inputFile3.getPath()};
    Main.main(args);
    ...
    public void myMainTest26() throws Exception {
        ...
        String args[] = {"-b", "HHowdy", "'Hello'", "--", inputFile1.getPath()};
        Main.main(args);
    ...
    public void myMainTest30() throws Exception {
    	...
    	//Test Case 74 		(Key = 2.2.2.2.0.4.2.0.2.1.3.1.2.1.)
    	//   Size                :  Not empty
    	//   Presence of a file  :  Present
    	//   Number of files     :  >0
    	//   Name                :  Not Empty
    	//   Content             :  <n/a>
    	//   Commands            :  -i
        ...
        String args[] = {"-i", "BBill", "William", "--", inputFile1.getPath()};
        Main.main(args);
    ...
    public void myMainTest31() throws Exception {
        ...
        String args[] = {"-b", "-f","Bill", "William", "--", inputFile2.getPath()};
        Main.main(args);
    ...
    public void myMainTest32() throws Exception {
        ...
        String args[] = {"-i", "'BBill'", "William", "--", inputFile1.getPath(), inputFile2.getPath(), inputFile3.getPath()};
        Main.main(args);
    ...
    public void myMainTest35() throws Exception {
        ...
        String args[] = {"-f", "--", "Bill", "William", "--", inputFile1.getPath()};
        Main.main(args);
    ...
    public void myMainTest38() throws Exception {
        ...
        String args[] = {"-b", "-i", "BBill", "William", "--", inputFile1.getPath()};
        Main.main(args);
    ...
    public void myMainTest39() throws Exception {
        ...
        String args[] = {"-b", "-i", "Bill", "William", "--", inputFile1.getPath()};
        Main.main(args);
    ...
    public void myMainTest40() throws Exception {
        ...
        String args[] = {"-i","-l", "HHowdy", "Hello", "--", inputFile1.getPath(), inputFile2.getPath(), inputFile3.getPath()};
        Main.main(args);
